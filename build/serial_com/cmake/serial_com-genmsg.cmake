...
set(MSG_I_FLAGS "-Iserial_com:/home/lym/Autoaim/src/serial_com/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/lym/Autoaim/src/serial_com/msg/comm.msg" NAME_WE)
add_custom_target(_serial_com_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "serial_com" "/home/lym/Autoaim/src/serial_com/msg/comm.msg" ""
)
...
_generate_msg_cpp(serial_com
  "/home/lym/Autoaim/src/serial_com/msg/comm.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/serial_com)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/serial_com\")")
  # install generated code
  install(
